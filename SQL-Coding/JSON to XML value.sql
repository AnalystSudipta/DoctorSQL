...
SELECT
 ...
 XMLELEMENT("JSON_To_XML",
            XMLAGG(XMLELEMENT("JSON_To_XML_TAG",
                              XMLELEMENT("Name", JT.NAME),
                              XMLELEMENT("Age", JT.AGE),
                              XMLELEMENT("Street", JT.street),
                              XMLELEMENT("City", JT.city),
                              XMLELEMENT("Country", JT.country),
                              XMLELEMENT("Contact_type", JT.contact_type),
                              XMLELEMENT("Contact_value", JT.contact_value)
